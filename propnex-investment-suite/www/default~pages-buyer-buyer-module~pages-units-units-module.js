...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (".error-message {\n  color: red;\n  margin-top: 5px;\n}\n/*# sourceMappingURL=data:application/json;base64, */");
...
<<<<<<< Updated upstream
        this.placeService.checkPostalCodeExists(postalCode).subscribe(function (exists) {
            if (exists) {
                // Postal code already exists, handle accordingly (e.g., show an error message)
                _this.postalCodeError = "Postal code already exists. Please choose a unique postal code.";
            }
            else {
                _this.postalCodeError = null; // Clear any previous error
                // Postal code is unique, proceed with adding the new block
                var projectName = _this.addBlockForm.value.projectName;
                var address = _this.addBlockForm.value.address;
=======
...
<<<<<<< Updated upstream
                _this.placeService.addBlock(projectName, address, postalCode, landArea, grossFloorArea, tenure, numRooms, numStorey, askingPrice, priceRoom, GFA, roomRate, netOperatingProfit, approvedUsage, region, locationMRT, locationSch, district).subscribe(function () {
=======
